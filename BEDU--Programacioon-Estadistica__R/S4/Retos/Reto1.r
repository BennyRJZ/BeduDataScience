...
# Consideremos un experimento binomial con n = 35 pruebas
# idénticas e independientes, en donde la probabilidad de éxito en 
# cada prueba es p = 0.51. Encuentre lo siguiente:
#   
  
# La probabilidad de observar exactamente 10 éxitos
dbinom(x=10, p = 0.51, size = 35)
# La probabilidad de observar 10 o más exitos
pbinom(q = 9, size = 35, prob = 0.51,  lower.tail = FALSE)
# El cuantil de orden 0.5
qbinom(p=.5,size=35,prob = 0.51)
# Genere una muestra aleatoria de tamaño 1000 de esta distribución,
# construya una tabla de frecuencias relativas con los resultados 
# y realice el gráfico de barras de los resultados que muestre las 
